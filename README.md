...
|---|---|---|
| [Adaptive Perovskite Recovery PV](./perovskite-recovery-pv/) | Concentrated perovskite photovoltaics using controlled light/dark recovery cycles, thermal management, and history-aware adaptive control | **SPORAN / TRAŽI EKSPERIMENT** |
...
The system may track illumination dose, temperature, dark time, electrical performance, and estimated state of health of individual photovoltaic regions and adapt exposure and recovery schedules accordingly.

[Read the defensive disclosure](./perovskite-recovery-pv/defensive_disclosure_adaptive_perovskite_recovery_pv_v01.md)
